...
var countryListColumns = []string{
	"id", "common_name", "formal_name", "type", "sub_type", "sovereignty", "capital", "iso_4217_currency_code", "iso_4217_currency_name", "itu_t_telephone_code", "iso_3166_1_2_letter_code", "iso_3166_1_3_letter_code",
	"iso_3166_1_number", "iana_country_code_tld",
}
var countryListData = [][]string{
	{"1", "Afghanistan", "Islamic Republic of Afghanistan", "Independent State", "", "", "Kabul", "AFN", "Afghani", "+93", "AF", "AFG", "004", ".af"},
...
var groupsData = [][]string{
	...
	{"-8", "Anonymous", "Anonymous users"},
}

var usersColumns = []string{
	"id", "login", "pwd", "pwd_salt",
	"fullname", "email", "group_id",
}
var usersData = [][]string{
	{"-1", "adm", "mysecretpass", "", "Administrator", "", "-2"},
	{"-7", "anonymous", "noPasswordForAnonymous", "", "Anonymous User", "", "-8"},
}

var usersGroupsColumns = []string{
	"user_id", "group_id",
}
var usersGroupsData = [][]string{
	{"-1", "-2"},
	{"-1", "-5"},
	{"-1", "-6"},
	{"-7", "-4"},
...
var foldersData = [][]string{
	{"0", "-1", "-6", "rwxrw-r--", "-1", "2025-11-10 09:43:44", "-1", "2025-11-10 09:43:44", "NULL", "NULL", "NULL", "root", "Default root folder", "NULL", "-10"},
	{"-10", "-1", "-6", "rwxrw-r--", "-1", "2025-11-10 09:43:44", "-1", "2025-11-10 09:43:44", "NULL", "NULL", "0", "Home", "", "NULL", "-11,-12,-13,-14"},
	{"-11", "-1", "-6", "rwxrw-r--", "-1", "2025-11-10 09:43:44", "-1", "2025-11-10 09:43:44", "NULL", "NULL", "-10", "Products", "", "NULL", ""},
	{"-12", "-1", "-6", "rwxrw-r--", "-1", "2025-11-10 09:43:44", "-1", "2025-11-10 09:43:44", "NULL", "NULL", "-10", "Services", "", "NULL", ""},
	{"-13", "-1", "-6", "rwxrw-r--", "-1", "2025-11-10 09:43:44", "-1", "2025-11-10 09:43:44", "NULL", "NULL", "-10", "Downloads", "", "NULL", ""},
	{"-14", "-1", "-6", "rwxrw-r--", "-1", "2025-11-10 09:43:44", "-1", "2025-11-10 09:43:44", "NULL", "NULL", "-10", "About us", "", "NULL", ""},
}

var pagesColumns = []string{
	"id", "owner", "group_id", "permissions",
	"creator", "creation_date", "last_modify", "last_modify_date",
	"deleted_by", "deleted_date",
	"father_id", "name", "description", "html",
	"fk_obj_id", "language",
}
